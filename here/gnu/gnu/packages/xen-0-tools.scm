;; xen-tools.scm 20191020,gl for an environment to build the xen-tools
;; use:
;;  guix environment -l s/xen-0-tools.scm
;;    guix build --load=s/xen-0-tools.scm

(define-module (gnu packages xen-0-tools)
  ...
  #:use-module (gnu packages xen-0-qemu)
...
;;xen-0-tools ;; guix environment -l s/xen-tools
